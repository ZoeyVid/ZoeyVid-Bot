module.exports = {
	...
	async execute(interaction, client) {
        ...
        if (interaction.commandName === 'ping') interaction.reply({
            content: "Pong! **" + client.ws.ping + "ms**",
            ephemeral: true
        });
        if (interaction.commandName === 'twitter') interaction.reply({
            content: "Sanoj: https://twitter.com/2020sanoj \n musik_handy: Nope \n DavidCraft: https://twitter.com/david__craft",
            ephemeral: true
        });
        if (interaction.commandName === 'modinstaller') interaction.reply({
            content: "Zu Sanojs Mod-Installer: https://github.com/2020Sanoj/Mod-Installer",
            ephemeral: true
        });
        if (interaction.commandName === 'github') interaction.reply({
            content: "Sanoj: https://github.com/2020sanoj \n musik_handy: Nope \n DavidCraft: https://github.com/davidcraftdev",
            ephemeral: true
        });
        if (interaction.commandName === 'regeln') interaction.reply({
