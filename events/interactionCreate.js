module.exports = {
  ...
  async execute(interaction, client) {
    ...
    var regeln = await client.guilds.cache
      .get("840285826020933662")
      .channels.cache.get("840286217320530003")
      .messages.fetch("870395962097537084");
